...
def inspect_axis_config(config: str) -> dict:
    ...
    summary = {
        ...
        "basis_path": str(cfg.basis.source) if cfg.basis.source is not None else None,
        "basis_prev_path": str(cfg.basis.prev_source) if cfg.basis.prev_source is not None else None,
        "basis_next_path": str(cfg.basis.next_source) if cfg.basis.next_source is not None else None,
