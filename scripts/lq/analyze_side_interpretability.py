...
if __package__ in {None, ""}:
    ...
    from scripts.lq.analyze_checkpoint import build_eval_dataset, build_specs, fit_linear_probe
    from scripts.lq.model.network import DistNet
else:
    from .analyze_checkpoint import build_eval_dataset, build_specs, fit_linear_probe
