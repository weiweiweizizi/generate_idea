...
def analyze(
    patient_profiles_csv: str = "outputs/disentangleNet_trainprobe/v32_tri_region_masked_win20_e50/window_basis_activations_all/patient_pattern_analysis/patient_profile_summary/patient_activation_profiles.csv",
