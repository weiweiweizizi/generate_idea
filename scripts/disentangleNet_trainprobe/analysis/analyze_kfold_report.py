...
2. 自定义折数：
   `python scripts/disentangleNet_trainprobe/analysis/analyze_kfold_report.py \\
      outputs/disentangleNet_trainprobe/v32_tri_region_masked_win20_e50/best.pt --requested_splits 10`
3. 自定义输出目录：
   `python scripts/disentangleNet_trainprobe/analysis/analyze_kfold_report.py \\
      outputs/disentangleNet_trainprobe/v32_tri_region_masked_win20_e50/best.pt \\
      --output_dir outputs/disentangleNet_trainprobe/v32_tri_region_masked_win20_e50/kfold_report_custom`
...
from scripts.disentangleNet_trainprobe.analysis.analyze_side_interpretability import (
    SIDE_LABEL_NAMES,
